...
const program = from(fetchDisbursments('2022-05-13', '2022-05-13')).pipe(
  // take(1),
    flatMap(ids => ids),
    // take(1),
    flatMap((disbursment) => {
                      ...
                      return {
                        ...
                        details_ship: await toArray(from(g).pipe(
                          ...
                          flatMap(async ({ shipmentId, details_ship }) => {
                            ...
                            // console.log(details_ship)
                            return {
                            // arrshipmentDetails.map((shipmentDetails) => ({
                              shipmentId,
                              details_ship,
                              shipmentDetails,
                            }
